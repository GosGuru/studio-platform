# ADR-007 — Figma MCP por nodo y sección
...
## Decisión
Figma MCP se utilizará sobre nodos concretos, primero para extraer contexto y luego para implementar secciones aisladas.

## Razón
La generación de páginas completas reduce control arquitectónico y dificulta revisar desviaciones.

## Consecuencias
Cada PR visual documentará archivo, nodo, adaptación y diferencias deliberadas.
